// SM Shariah Calculator — Service Worker v1.1.0
const CACHE = 'sm-shariah-v1.1.0';
const FILES = [
  './', './index.html', './manifest.json',
  './icon-192.png', './icon-512.png',
  'https://cdn.jsdelivr.net/npm/jameel-noori@1.0.5/fonts/jameel-noori-nastaleeq4.woff2'
];
